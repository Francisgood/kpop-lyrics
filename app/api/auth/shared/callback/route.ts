  ...
  try {
    ...
    if (error instanceof Error && error.message === "verified_email_required")
      return provisioningFailure(
        ...
        "Verify your email in Accounts, then return here and try signing in again.",
        {
          href: `${config.providerBaseUrl}/verify-email`,
          label: "Verify email in Accounts",
        },
      );
