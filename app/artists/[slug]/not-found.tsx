  ...
  return (
    <main style={{ minHeight: "60vh", display: "flex", alignItems: "center", justifyContent: "center", padding: "48px 24px" }}>
      <div style={{ maxWidth: 480, textAlign: "center" }}>
        ...
        <p style={{ color: "#666", fontSize: "0.95rem", marginBottom: 24, lineHeight: 1.6 }}>
          This artist page doesn't exist. They may not be in our database yet.
        </p>
        <div style={{ display: "flex", gap: 10, justifyContent: "center" }}>
          <Link href="/artists" style={{ background: "#FFFF64", color: "#000", fontWeight: 700, fontSize: "0.8rem", letterSpacing: "0.05em", textTransform: "uppercase", padding: "8px 20px", borderRadius: 4, textDecoration: "none" }}>
            Browse Artists
          </Link>
