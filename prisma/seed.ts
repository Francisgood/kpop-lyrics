...
Beyond music, Lisa is a global fashion icon — a house ambassador for Celine and brand partner for Bvlgari, MAC Cosmetics, and Samsung. She holds multiple Guinness World Records for social media achievement.`,
  ...
  // ── BATCH 5: 100 Korean / K-pop Slang Terms ─────────────────────────────────
  const slangTerms = [
    // ── K-pop Fandom / Idol culture ──────────────────────────────────────────
    { term: "aegyo", slug: "aegyo", defs: [{ body: "Cute, childlike behavior performed intentionally to appear charming or endearing. K-pop idols regularly display aegyo for fans during fansigns, variety shows, and live streams — pouting, using baby voices, or making cute gestures. The term comes from 애교 (愛嬌), meaning lovable charm. Fan communities often rank idols by their aegyo level.", example: "TWICE are famous for their aegyo — Nayeon's wink and Tzuyu's shy smile have become iconic fan-service moments.", votesUp: 5823, votesDown: 67 }] },
    { term: "oppa", slug: "oppa", defs: [{ body: "Korean word used by females to address an older male — literally 'older brother' but in fan culture refers to a male idol the fan considers charming or attractive. Saying 'oppa' to an idol implies warmth and closeness. Male idols performing cute or protective behavior are often praised as 'oppa material.' Non-Korean fans use it liberally, often playfully.", example: "Thousands of fans screamed 'OPPA!' when Jin walked onstage — his endearing smile is peak oppa energy.", votesUp: 6201, votesDown: 234 }] },
    { term: "noona", slug: "noona", defs: [{ body: "Korean word used by males to address an older female — literally 'older sister.' Male K-pop fans often refer to female idols as noona if they are older than the fan. Some male idols are famous for their 'noona fan base' — attracting older female admirers. 'Noona romance' is also a common K-drama trope.", example: "G-Dragon has always had a huge noona fanbase — his cool, mature vibe appeals to older female fans who call him 'our oppa-noona hybrid.'", votesUp: 3140, votesDown: 45 }] },
    { term: "hyung", slug: "hyung", defs: [{ body: "Korean word used by males to address an older male — literally 'older brother.' Within K-pop groups, younger male members address older members as hyung. Fan communities use 'hyung line' to refer to the older members of a group. The hyung-dongsaeng dynamic is a major part of group chemistry narratives.", example: "Jungkook, as BTS's maknae, calls all six members hyung — the warmth between him and Jin (the oldest) is a fan-favorite hyung dynamic.", votesUp: 4302, votesDown: 55 }] },
    { term: "sunbae", slug: "sunbae", defs: [{ body: "Senior or upperclassman — in K-pop, a group or artist that debuted earlier than another. Newer idols are expected to show respect to sunbae artists at award shows, music shows, and backstage. Receiving acknowledgment from a respected sunbae is considered a major milestone for rookie acts.", example: "When ILLIT bowed deeply to BLACKPINK backstage, fans celebrated the moment as a perfect sunbae-hoobae interaction.", votesUp: 2987, votesDown: 34 }] },
    { term: "hoobae", slug: "hoobae", defs: [{ body: "Junior or underclassman — the opposite of sunbae. A K-pop group or idol that debuted after another. Hoobae acts are expected to show deference and respect. When a veteran group publicly praises their hoobae, it's a major moment in fan communities. Many idol groups develop formal mentorship bonds with their sunbae.", example: "BTS went out of their way to compliment ENHYPEN as exceptional hoobae — the interaction trended on Twitter for two days.", votesUp: 2456, votesDown: 22 }] },
    { term: "hwaiting", slug: "hwaiting", defs: [{ body: "Korean phonetic spelling of the English phrase 'fighting' used as a cheer meaning 'you can do it' or 'go for it.' Fans shout 화이팅 at concerts before a difficult stage or when an idol is going through a hard time. It's also widely used as an encouragement on social media. Sometimes spelled 'fighting' or 'paiting.'", example: "After Jimin revealed he had been sick during the tour, thousands of fans flooded his Weverse with 화이팅 messages.", votesUp: 5110, votesDown: 89 }] },
    { term: "mukbang", slug: "mukbang", defs: [{ body: "An online broadcast format — from 먹방 (meokbang, 먹다 = eat + 방송 = broadcast) — where a host eats large amounts of food on camera while interacting with viewers. K-pop idols do mukbangs on Weverse Live, VLive, and YouTube to connect with fans. The format exploded globally and has become part of mainstream internet culture. Many idol fandoms keep archives of their bias's eating habits.", example: "Jungkook's mukbang streams are legendary in ARMY — he once ate three full meals on camera and still looked like a model doing it.", votesUp: 6780, votesDown: 122 }] },
    { term: "concept", slug: "concept", defs: [{ body: "The central theme, visual aesthetic, and mood of a K-pop group's comeback or album. Each release follows a distinct concept — dark/intense, cute, retro, futuristic, school-themed, etc. — which dictates everything from outfits to set design to song style. Fans debate whether a group 'suited' their concept, and critics analyze how well the concept was executed.", example: "aespa's 'MY WORLD' concept — hyper-futuristic avatars merging with a virtual SM universe — divided fans but became one of the most discussed concepts in 4th-gen K-pop.", votesUp: 3912, votesDown: 78 }] },
    { term: "killing part", slug: "killing-part", defs: [{ body: "The most memorable, exciting, or viral moment in a K-pop song — a lyric, dance move, vocal run, or beat drop that fans and casual listeners immediately recognize. The killing part is what gets clipped and shared on social media and often defines the song's cultural footprint. Also called the 'point choreography' when it's a specific dance section.", example: "The killing part of 'BOOMBAYAH' is the opening 'BLACKPINK IN YOUR AREA' — you hear three seconds and know the whole song.", votesUp: 4567, votesDown: 56 }] },
    { term: "choeae", slug: "choeae", defs: [{ body: "최애 — ultimate favorite. The one idol you love the most above all others. While 'bias' is the English equivalent, choeae is the native Korean term and carries stronger emotional weight in domestic fan culture. Having a choeae implies deep personal attachment — beyond casual fandom. When a fan changes their choeae it's treated as major news in their social circles.", example: "My choeae has been Taeyeon for six years — no comeback, hiatus, or new group has shaken that top spot.", votesUp: 3765, votesDown: 45 }] },
    { term: "chaae", slug: "chaae", defs: [{ body: "차애 — second favorite idol. The runner-up to your choeae. Many fans maintain a detailed ranking of their favorites, and chaae holds an important place — often the member the fan would 'adopt' if their choeae were unavailable. A chaae can easily become a bias wrecker on their way to overthrowing the choeae.", example: "My choeae is Jennie but my chaae is Rosé — her voice has been threatening to take the top spot since 'Gone' came out.", votesUp: 2890, votesDown: 34 }] },
    { term: "ipdeok", slug: "ipdeok", defs: [{ body: "입덕 — entering the fandom. The moment a person officially becomes a dedicated fan of a group or idol. K-pop fans often remember their ipdeok moment vividly — the specific song, video, or live stage that 'got' them. Sharing ipdeok stories is a beloved fan ritual on social media and in fan communities.", example: "My ipdeok moment for BTS was watching the 'IDOL' MV for the first time — by the end I had ordered two albums.", votesUp: 4120, votesDown: 38 }] },
    { term: "taldeok", slug: "taldeok", defs: [{ body: "탈덕 — leaving the fandom. When a fan steps back from or fully exits their dedication to a group or idol. Reasons range from a controversy, graduation, or simply drifting away. Taldeok is sometimes temporary ('I need a break') and sometimes permanent. The process of taldeok can feel emotionally significant, like ending a long relationship.", example: "After the disbandment announcement, dozens of fans posted their taldeok stories — some had been fans for 7 years.", votesUp: 3456, votesDown: 89 }] },
    { term: "deokjil", slug: "deokjil", defs: [{ body: "덕질 — fan activities. The full range of behaviors that constitute being a dedicated K-pop fan: streaming, buying albums, attending concerts, collecting photocards, running fan accounts, translating content, and more. Deokjil is both a noun (the activities themselves) and a verb (to engage in those activities). The term comes from 덕후 + 질 (the suffix meaning 'to do/practice').", example: "I spent all weekend doing deokjil — updated three photocard binders, streamed the new album 40 times, and submitted annotations to two fan wikis.", votesUp: 3234, votesDown: 23 }] },
    { term: "deokhu", slug: "deokhu", defs: [{ body: "덕후 — a hardcore fan or obsessive enthusiast. Borrowed from the Japanese word 'otaku,' but adapted into Korean culture. A deokhu isn't just a casual fan — they are deeply invested, knowledgeable, and dedicated. In K-pop, a deokhu might own every album version, attend all tour stops in their region, and maintain detailed fan archives. The term is used affectionately within fan communities.", example: "She's a true deokhu — her apartment has an entire room dedicated to SEVENTEEN merchandise and she's seen them live 14 times.", votesUp: 2876, votesDown: 34 }] },
    { term: "seongdeok", slug: "seongdeok", defs: [{ body: "성덕 — a fan who has achieved their dream. Specifically, someone who has successfully met their idol, gotten a photocard signed, or had a meaningful interaction with their bias. The term combines 성공한 덕후 (successful fan). Being a seongdeok is a major milestone celebrated by the whole fan community.", example: "She became a seongdeok last week — Jimin saw her handmade sign, pointed at her, and waved. She cried for an hour.", votesUp: 5123, votesDown: 45 }] },
    { term: "kemi", slug: "kemi", defs: [{ body: "케미 — chemistry between two or more people. From the English word 'chemistry' filtered through Korean pronunciation. In K-pop, kemi describes the natural energy and connection between group members, between an artist and a fan, or between collaborating artists. Strong kemi between members fuels 'ship' culture and variety show entertainment.", example: "Jimin and J-Hope's kemi is off the charts — their playful bickering and genuine warmth have fans calling them 'the most natural duo in BTS.'", votesUp: 4780, votesDown: 55 }] },
    { term: "rijeu", slug: "rijeu", defs: [{ body: "리즈 — peak era. A person's prime time — when they looked, performed, or were most popular. Comes from the English football club 'Leeds United' in a meme context, but in Korean internet culture evolved to mean someone's best period. In K-pop, 'rijeu' refers to the comeback or era when an idol was at their absolute best — physically, vocally, or in terms of public profile.", example: "Fans argue endlessly about IU's rijeu — some say 'Good Day,' others say 'LILAC,' but most agree she's been in continuous rijeu since 2011.", votesUp: 3901, votesDown: 67 }] },
    { term: "kalgunmu", slug: "kalgunmu", defs: [{ body: "칼군무 — knife group dance. Perfectly synchronized group choreography where every member executes every move at the exact same angle, speed, and height simultaneously — as sharp and precise as a knife. Kalgunmu is one of the most celebrated skills in K-pop. Groups known for their kalgunmu are considered technically elite.", example: "SEVENTEEN's kalgunmu is legendary — 13 members moving as one body. Their 'Super' stage is studied in dance schools as a benchmark of group sync.", votesUp: 5632, votesDown: 23 }] },
    { term: "meogeul", slug: "meogeul", defs: [{ body: "머글 — a 'muggle,' borrowed from Harry Potter. Refers to someone who is not a K-pop fan — an outsider to fandom culture who doesn't understand the references, the investments, or the emotional connections fans make. Used affectionately or with mild exasperation when explaining K-pop to non-fans.", example: "I tried to explain the photocard system to my roommate but he's a total meogeul — he just kept asking why I needed 12 copies of the same album.", votesUp: 4201, votesDown: 78 }] },
    { term: "yeokjuhaeng", slug: "yeokjuhaeng", defs: [{ body: "역주행 — reverse run. When a song, album, or artist unexpectedly surges in popularity long after its original release — the opposite of the typical downward chart trajectory. A yeokjuhaeng can be triggered by a viral clip, a drama OST placement, or a challenge. It's one of the most celebrated phenomena in K-pop.", example: "TWICE's 'Cheer Up' had a famous yeokjuhaeng — a TikTok dance trend 4 years after release pushed it back into the top 10.", votesUp: 3456, votesDown: 34 }] },
    { term: "tteoksang", slug: "tteoksang", defs: [{ body: "떡상 — sudden dramatic rise. When something shoots up unexpectedly — a song's chart position, a stock price, a follower count. In K-pop fan communities, tteoksang describes the exhilarating moment when a song or artist breaks out virally. The opposite is 떡락 (tteoknak), a sudden crash.", example: "After their Coachella performance, BLACKPINK saw a tteoksang across all streaming platforms — their numbers doubled overnight.", votesUp: 3210, votesDown: 45 }] },
    { term: "eonpeul", slug: "eonpeul", defs: [{ body: "언플 — media play. Short for 언론 플레이 (media play). Strategic manipulation of media coverage — paying for favorable articles, arranging coordinated press releases, or orchestrating public moments — to boost an artist's profile or manage a scandal. Fans use eonpeul as a criticism when they feel an artist is getting undeserved hype through manufactured press.", example: "Fans accused the label of eonpeul after three separate 'spontaneous' news articles about the group dropped on the same day as a competitor's comeback.", votesUp: 3780, votesDown: 98 }] },
    { term: "jeong", slug: "jeong", defs: [{ body: "정 — deep emotional attachment and affection that develops naturally over time. A uniquely Korean concept without a direct English equivalent. Jeong is the bond that forms between fans and idols after years of following someone through all their eras, struggles, and growth. It's also the deep loyalty between group members. You can even develop jeong for a song or a place.", example: "After ten years of following BTS, I realized what I feel isn't just fandom — it's 정. Their music is woven into every major moment of my life.", votesUp: 7823, votesDown: 45 }] },
    { term: "nunchi", slug: "nunchi", defs: [{ body: "눈치 — social awareness. The ability to read the room, pick up on unspoken cues, and respond appropriately in social situations. An idol with good nunchi handles fan interactions, interview questions, and group dynamics gracefully. Lacking nunchi is a common criticism of tone-deaf celebrity behavior.", example: "Jungkook's nunchi during interviews is remarkable — he consistently gives thoughtful answers that acknowledge what the interviewer actually wants to know.", votesUp: 3120, votesDown: 45 }] },
    { term: "ending fairy", slug: "ending-fairy", defs: [{ body: "The idol who appears on screen during the last shot of a music show performance — after the song ends, the camera holds on one member for a few seconds. The 'ending fairy' moment often goes viral because the idol is improvising — smiling, posing, or looking directly into the camera. Being a charismatic ending fairy is a celebrated skill.", example: "Karina's ending fairy moments for aespa's 'Spicy' stage broke record view counts — her confident gaze into the camera became a standalone meme.", votesUp: 6234, votesDown: 56 }] },
    { term: "teaser", slug: "teaser", defs: [{ body: "Pre-release promotional content released before an album or single drops — teaser photos, concept clips, short video snippets. K-pop labels release teasers in carefully orchestrated schedules, building anticipation and driving social media activity. Fans analyze teasers obsessively for clues about the concept, members' looks, or hidden lore.", example: "BLACKPINK's 'BORN PINK' teaser campaign was a masterclass — each member's solo teaser photo dropped days apart and individually trended worldwide.", votesUp: 3890, votesDown: 34 }] },
    { term: "fancafe", slug: "fancafe", defs: [{ body: "An official fan community hosted on Korean platforms like Daum or Naver — the primary space where Korean domestic fans organize, share content, and communicate with each other. International fans use platforms like Weverse or fan forums, but fancafes remain the inner sanctum of Korean fandom. Members post letters, photos, and announcements that only registered members can access.", example: "The fancafe exploded after Suga posted a handwritten letter — the servers crashed within minutes from the flood of members logging in to read it.", votesUp: 2345, votesDown: 23 }] },
    { term: "fanmeeting", slug: "fanmeeting", defs: [{ body: "An event where K-pop idols meet fans in an intimate setting — smaller than a concert, focused on fan interaction rather than performance. Activities include games, Q&A sessions, gift exchanges, and brief one-on-one moments. Fanmeeting tickets are highly competitive and often require lottery systems. For fans, attending a fanmeeting is a milestone bucket-list item.", example: "BTS's fanmeetings are famous for their intimate atmosphere — members spend hours talking with fans, reading fan letters, and playing games together onstage.", votesUp: 4120, votesDown: 34 }] },
    // ── Korean Gen Z / Internet Slang ─────────────────────────────────────────
    { term: "daebak", slug: "daebak", defs: [{ body: "대박 — awesome, amazing, jackpot. Originally meaning 'great success' or 'windfall,' it evolved into a general exclamation of amazement or excitement. Daebak is one of the most widely borrowed Korean slang terms in K-pop fan communities worldwide. Fans use it to react to surprise announcements, stunning visuals, or unexpected chart results.", example: "BTS announced a world tour with 50 cities — ARMY's response was an immediate global chorus of 'DAEBAK!!!'", votesUp: 8920, votesDown: 145 }] },
    { term: "heol", slug: "heol", defs: [{ body: "헐 — 'what?!' / 'oh no' / 'seriously?!' An expression of moderate shock or disbelief. Lighter than a genuine crisis reaction — more like a surprised gasp. Used in texting, social media comments, and reactions to unexpected K-pop news. International fans have adopted it wholesale.", example: "SM dropped a surprise comeback announcement at midnight — every reply in the comments was just 'HEOL 헐 HEOL'", votesUp: 4123, votesDown: 56 }] },
    { term: "jjin", slug: "jjin", defs: [{ body: "찐 — real, genuine, authentic. Used to emphasize that something is the true version of itself, not fake or exaggerated. In K-pop fan culture, 찐 is applied to idols who seem genuinely themselves rather than performing a persona — 찐텐션 (jjin tension) means authentic excitement as opposed to forced energy.", example: "Fans praised Jennie's Cannes interview as total 찐 — she was relaxed, funny, and completely herself rather than in idol mode.", votesUp: 3450, votesDown: 45 }] },
    { term: "injeong", slug: "injeong", defs: [{ body: "인정 — 'I admit it' / 'I acknowledge that.' Used as a concession in arguments or a stamp of agreement. In K-pop fan debates — chart accuracy, vocal rankings, group comparisons — 인정 is the term used when someone accepts a point they were initially disagreeing with. It signals intellectual honesty and is respected in fan discussion spaces.", example: "Even SKZ stans had to do an 인정 when BTS's 'Hooligan' outsold every 4th-gen group's first-week numbers.", votesUp: 3234, votesDown: 67 }] },
    { term: "kingbatda", slug: "kingbatda", defs: [{ body: "킹받다 — extremely annoyed or triggered. A portmanteau of 'king' (킹) as an intensifier + 받다 (to receive/get). When something is so irritating it gives you king-level frustration. Used to react to tone-deaf celebrity behavior, unfair chart manipulations, or exasperating fan wars.", example: "That label posted a 2-minute teaser video with literally 4 seconds of actual content. 킹받다.", votesUp: 3120, votesDown: 56 }] },
    { term: "rejeondeu", slug: "rejeondeu", defs: [{ body: "레전드 — legendary, iconic. From the English word 'legend.' Used to describe a performance, stage, moment, or person that is considered historically outstanding. In K-pop fan discourse, declaring something a 레전드 is the highest possible praise. Famous stages become 'the 레전드 Inkigayo performance' or 'the 레전드 MAMA stage.'", example: "BTS's 2018 MAMA medley performance is universally called a 레전드 — fans still post frame-by-frame breakdowns of it in 2026.", votesUp: 5678, votesDown: 78 }] },
    { term: "michyeotda", slug: "michyeotda", defs: [{ body: "미쳤다 — 'that's insane' / 'I'm losing my mind.' Literally 'went crazy' but used as a hyperbolic expression of being overwhelmed by something impressive or unbelievable. The K-pop equivalent of 'what is happening?' reacted to a godtier performance or a truly unexpected announcement.", example: "ROSÉ's live vocal run in 'Gone' at the Grammy Museum performance — 미쳤다. How is that voice real?", votesUp: 4890, votesDown: 67 }] },
    { term: "kkuljaem", slug: "kkuljaem", defs: [{ body: "꿀잼 — super fun, entertaining, hilarious. Combines 꿀 (honey) + 재미 (fun) — honey-level fun. Used for videos, reality show episodes, fan events, or variety content that is genuinely entertaining. The opposite is 노잼 (nojaem).", example: "BTS's Run BTS episodes are peak 꿀잼 — the members' chemistry and chaotic energy makes every episode rewatchable.", votesUp: 4321, votesDown: 45 }] },
    { term: "nojaem", slug: "nojaem", defs: [{ body: "노잼 — boring, unfunny, a letdown. Combines 노 (no) + 재미 (fun). Used to describe a disappointing performance, a lackluster comeback, a variety show episode with no chemistry, or content that simply fails to deliver. Politely but firmly dismissive.", example: "The new reality show concept was completely 노잼 — they replaced the natural chaos of the members with scripted challenges and it showed.", votesUp: 3210, votesDown: 89 }] },
    { term: "menbung", slug: "menbung", defs: [{ body: "멘붕 — mental breakdown / mind blown. Short for 멘탈 붕괴 (mental collapse). Describes the overwhelming cognitive/emotional state when something in K-pop is too much to process — a surprise comeback, a shocking controversy, an unexpected disbandment, or a performance so good your brain can't handle it.", example: "ARMY collectively went through 멘붕 when all seven members appeared together for the first time after military service during the MAMA broadcast.", votesUp: 5432, votesDown: 78 }] },
    { term: "gapbunssa", slug: "gapbunssa", defs: [{ body: "갑분싸 — sudden mood killer. Short for 갑자기 분위기 싸해졌어 (suddenly the atmosphere turned cold). When an awkward moment or piece of information kills the mood at a fan event, in a group chat, or during a live broadcast. Often used humorously to describe tonal whiplash in variety shows.", example: "The host asked about the dating rumors right in the middle of the lighthearted game segment — instant 갑분싸. You could feel the whole studio tense up.", votesUp: 2980, votesDown: 45 }] },
    { term: "geukheom", slug: "geukheom", defs: [{ body: "극혐 — extreme disgust. Short for 극도의 혐오 (extreme revulsion). Used to express strong negative feelings about something deeply off-putting — a controversial outfit choice, a tone-deaf interview response, or cringe-inducing fan behavior. Stronger than mere dislike; implies visceral repulsion.", example: "The photocard scalpers charging 300% markup are 극혐 — they're exploiting fans who just want to collect their bias.", votesUp: 3456, votesDown: 134 }] },
    { term: "utpeuda", slug: "utpeuda", defs: [{ body: "웃프다 — funny-sad. A portmanteau of 웃기다 (funny) + 슬프다 (sad). Used when something makes you laugh but also makes you feel a pang of sadness simultaneously — the bittersweet feeling of watching a beloved group age, or finding the humor in a painful situation.", example: "The 10th anniversary fan video was so 웃프다 — watching baby debut footage cut against their sold-out stadium era was both hilarious and emotional.", votesUp: 4123, votesDown: 34 }] },
    { term: "simkung", slug: "simkung", defs: [{ body: "심쿵 — heart flutter. From 심장 (heart) + 쿵 (thud sound). The feeling when an idol does something unexpectedly sweet, charming, or attractive and your heart drops. One of the most common reactions to idol content — used for everything from a casual smile in a vlog to a breathtaking stage look.", example: "Taehyung's candid airport photo — no styling, just glasses and a sweater — caused absolute 심쿵 across all platforms.", votesUp: 5678, votesDown: 45 }] },
    { term: "eba", slug: "eba", defs: [{ body: "에바 — 'that's too much' / going overboard. From the English 'over' via a creative phonetic route. Used to call out exaggeration, excessive claims, or dramatic behavior. In fan communities, it's used both critically (calling out overhyped claims) and affectionately (when a fan's love goes into theatrical territory).", example: "Saying Jungkook's voice is better than Freddie Mercury's is a little 에바. Let's stay in reality.", votesUp: 2987, votesDown: 123 }] },
    { term: "inssa", slug: "inssa", defs: [{ body: "인싸 — popular insider. From the English 'insider.' Describes a socially connected, outgoing, well-liked person who is always in the center of activity. In K-pop, certain idols are famous inssa within their peer groups — always organizing gatherings, knowing everyone, being the social glue. The opposite is 아싸 (assa, outsider).", example: "J-Hope is the ultimate inssa of BTS — he brings the whole group together with his energy and seems to be friends with literally every idol in the industry.", votesUp: 4201, votesDown: 56 }] },
    { term: "assa", slug: "assa", defs: [{ body: "아싸 — outsider. From the English 'outsider.' Describes someone introverted, socially disconnected, or on the fringe of a group. Some idols self-identify as assa, finding the idol social scene overwhelming. Among fans, calling yourself an assa is usually self-deprecating humor about spending all your time watching K-pop content rather than socializing.", example: "Yoongi often describes himself as a natural 아싸 who ended up in a group — the contrast between his loner personality and BTS's hyper-social image makes fans love him even more.", votesUp: 3456, votesDown: 78 }] },
    { term: "silhwanya", slug: "silhwanya", defs: [{ body: "실화냐 — 'is this real?' / 'are you serious?' Expresses disbelief at something that seems too good, too bad, or too absurd to be true. Common reaction to unexpected news in K-pop — a sudden comeback announcement, a record-breaking chart result, or a controversial statement.", example: "Lisa posted the 'Alter Ego' tracklist at 3am with zero warning — 실화냐??? was the most-replied comment in every fan community for hours.", votesUp: 3890, votesDown: 45 }] },
    { term: "real", slug: "real", defs: [{ body: "레알 — 'really' / 'genuinely' / 'for real.' Borrowed from Spanish 'real' via internet slang. Used as an intensifier to emphasize that something is absolutely true or to express genuine feeling. In K-pop fan communities, 레알 is used to validate strong reactions.", example: "레알 no one expected them to do a full 26-song setlist. They actually performed every title track. 레알 legends.", votesUp: 2345, votesDown: 34 }] },
    { term: "jjal", slug: "jjal", defs: [{ body: "짤 — meme, reaction image, or screenshot. The foundational unit of K-pop internet humor. A 짤 can be a still frame from a performance, a screencap of a funny comment, or a well-timed reaction photo. K-pop fan communities are prolific generators of 짤 content, and certain idol expressions become enduring reaction images used across all contexts.", example: "Suga's 'are you kidding me' face from that one Run BTS episode became such a classic 짤 it gets used in arguments about completely unrelated topics.", votesUp: 5123, votesDown: 56 }] },
    { term: "umjjal", slug: "umjjal", defs: [{ body: "움짤 — GIF (animated image). From 움직이는 짤 (moving meme/image). K-pop fan communities create and share enormous libraries of 움짤 — looping clips of iconic dance moments, funny facial expressions, or spectacular stage entrances. A well-timed 움짤 can win any argument in a K-pop fan thread.", example: "I can express every possible emotional state using only TWICE 움짤. Their range of facial expressions is a goldmine.", votesUp: 3780, votesDown: 45 }] },
    { term: "byeongmat", slug: "byeongmat", defs: [{ body: "병맛 — absurdly funny, nonsensically hilarious. Literally 'sick taste' — describes content or humor that is so random, bizarre, or low-effort that it loops around to being genuinely funny. K-pop groups doing intentionally weird variety show segments, chaotic behind-the-scenes content, or self-aware cringe performances often get labeled 병맛 as praise.", example: "The BTS members improvising a 2-minute play about a rubber duck losing its job is the definition of 병맛 — no logic, no point, completely perfect.", votesUp: 4320, votesDown: 67 }] },
    { term: "gwanjong", slug: "gwanjong", defs: [{ body: "관종 — attention seeker. Short for 관심종자 (attention seed). Someone who constantly craves the spotlight and manufactures situations to be noticed. In K-pop, the term applies to idols who seem to perform every interaction for cameras or fans who make every situation about themselves. Can be said affectionately (the lovable ham) or as genuine criticism.", example: "Jin is famously the group 관종 of BTS — his entire personality is 'look at me' and the entire fandom loves him for it.", votesUp: 3210, votesDown: 89 }] },
    { term: "kkondae", slug: "kkondae", defs: [{ body: "꼰대 — a preachy, rigid older person who constantly references 'the old ways' and lectures younger people. In K-pop commentary, kkondae describes industry veterans or senior idols who dismiss younger groups for 'not having real talent' or gatekeep what counts as legitimate K-pop. The term has become a broader Gen Z criticism of any boomer-style moralizing.", example: "That retired producer's interview calling 4th gen 'too idol-ized and not musical enough' was pure 꼰대 energy — every generation's elders say the same thing.", votesUp: 3456, votesDown: 78 }] },
    { term: "jjang", slug: "jjang", defs: [{ body: "짱 — the best, number one, awesome. Originally used to mean 'the boss' or 'the strongest' in Korean slang. In K-pop and general Korean youth culture, it's used as enthusiastic affirmation — something is just the best. Often combined: 얼짱 (best face), 몸짱 (best body), 춤짱 (best dancer).", example: "Choreographer's comment on the performance: '짱이야.' That's all. Nothing more needed. The stage spoke for itself.", votesUp: 3789, votesDown: 34 }] },
    { term: "eoljjang", slug: "eoljjang", defs: [{ body: "얼짱 — someone with an exceptionally beautiful or attractive face. From 얼굴 (face) + 짱 (best). Before Instagram, eoljjang culture on Korean websites like DC Inside was where teens posted photos to be rated on their looks. In K-pop, idol faces are constantly discussed and ranked using this framework.", example: "Cha Eun-woo is consistently ranked an 얼짱 even by non-fans — the beauty standard discussion around him is practically a standalone internet genre.", votesUp: 4567, votesDown: 89 }] },
    { term: "momjjang", slug: "momjjang", defs: [{ body: "몸짱 — someone with a great body. From 몸 (body) + 짱 (best). In K-pop, idol physiques are closely followed by fans — gym photos, shirtless stages, and body reveals generate enormous engagement. 몸짱 is used both appreciatively and as commentary on K-pop's intense physical standards for performers.", example: "Jungkook's 'Butter' award-stage outfit moment — absolute 몸짱 reveal. The gym content posts finally made sense.", votesUp: 5678, votesDown: 156 }] },
    { term: "sonjeol", slug: "sonjeol", defs: [{ body: "손절 — cutting someone off, ghosting, ending a relationship. From 손 (hand) + 절단 (cut). In K-pop fan culture, used when a fan decides to stop supporting an idol after a controversy, or when friends cut off someone toxic. Also used when discussing labelmates who publicly distanced themselves after a scandal.", example: "After the company's handling of the situation, a lot of fans did 손절 — not just unfollowing but actively removing merch from their spaces.", votesUp: 3234, votesDown: 67 }] },
    { term: "yeokdaegeup", slug: "yeokdaegeup", defs: [{ body: "역대급 — best ever, unprecedented, all-time level. From 역대 (throughout history) + 급 (level/class). The highest possible compliment — something that surpasses everything that came before it. Applied to performances, chart records, album sales, and visuals. 역대급 is not given lightly in serious fan discourse.", example: "BLACKPINK's Coachella headlining set is universally considered 역대급 for K-pop acts — the scale, the production, the cultural moment it represented.", votesUp: 5432, votesDown: 34 }] },
    { term: "nunting", slug: "nunting", defs: [{ body: "눈팅 — lurking. From 눈 (eyes) + chatting. Observing or reading content without actively participating — reading fan threads without commenting, watching livestreams without sending chats, or being in a group chat without responding. In K-pop communities, 눈팅 is extremely common among fans who follow content closely but prefer to remain anonymous.", example: "I've been 눈팅 this subreddit for three years without ever posting — then today I had a take strong enough to break my silence.", votesUp: 2890, votesDown: 23 }] },
    { term: "ilksip", slug: "ilksip", defs: [{ body: "읽씹 — left on read. From 읽다 (to read) + 씹다 (to chew/ignore). When someone reads your message but doesn't reply. A major source of social anxiety in Korean digital culture. In K-pop, famous for when idols' personal DMs to each other are referenced — or when idol accounts are seen 'reading' fan comments without responding during live streams.", example: "He literally typed '읽씹'을 당했어' in the group chat after waiting six hours for a reply that never came.", votesUp: 3456, votesDown: 45 }] },
    { term: "eonpal", slug: "eonpal", defs: [{ body: "언팔 — unfollow. Short for 언팔로우 (unfollow). The act of removing someone from your social media follows. In K-pop fan communities, mass 언팔 campaigns are sometimes organized against idol accounts after controversies. An idol's sudden Instagram follower drop can trigger immediate fan investigation.", example: "After the statement, the idol's Instagram lost 200K followers in 12 hours — the mass 언팔 was tracked in real time by fan charts.", votesUp: 2789, votesDown: 56 }] },
    { term: "matpal", slug: "matpal", defs: [{ body: "맞팔 — mutual follow. When two accounts follow each other on social media. In K-pop fan culture, asking for 맞팔 in bios is a way to build a fan network. When an idol accidentally follows back a fan account, it becomes legendary. Idol 맞팔 discoveries regularly trend in fan communities.", example: "Jimin's account briefly followed a fan edit page before the label's social team caught it — the 맞팔 moment screenshotted at the exact second it happened.", votesUp: 3120, votesDown: 34 }] },
    { term: "selka", slug: "selka", defs: [{ body: "셀카 — selfie. From 셀프 (self) + 카메라 (camera). One of the most beloved forms of K-pop content — idol selfies taken backstage, at airports, or at home give fans an intimate 'unfiltered' view of their favorite artists. Albums sometimes include selka photocards. Idol groups with active Weverse or Instagram presence generate enormous engagement from selfie posts.", example: "RM posts the most intellectual 셀카 — always at a gallery or bookshop, always with an unexpectedly sincere caption.", votesUp: 4567, votesDown: 45 }] },
    { term: "bepeu", slug: "bepeu", defs: [{ body: "베프 — best friend. From the English 'best friend' filtered through Korean phonetics. In K-pop, the 베프 dynamic between group members is deeply celebrated by fans — especially when two members have an obvious, long-standing closeness that feels natural rather than performed. 베프 pairings generate dedicated shipper communities.", example: "Jimin and Jungkook's 베프 energy is impossible to fake — they've been inseparable since Jungkook's trainee days and it shows in every interaction.", votesUp: 4234, votesDown: 45 }] },
    { term: "bulgeum", slug: "bulgeum", defs: [{ body: "불금 — fire Friday / TGIF. From 불 (fire) + 금요일 (Friday). The excitement of Friday as the gateway to the weekend. In K-pop, many albums and music videos are strategically released on Fridays (often midnight KST) to maximize streaming. Fan communities prepare for 불금 comebacks with streaming guides, playlist links, and coordinated listening parties.", example: "The label chose 불금 midnight for the comeback drop — ARMY had coffee and streaming playlists ready by Thursday evening.", votesUp: 3210, votesDown: 34 }] },
    { term: "hokangseu", slug: "hokangseu", defs: [{ body: "호캉스 — hotel staycation. From 호텔 (hotel) + 바캉스 (vacation, from French 'vacances'). Spending a vacation in a hotel rather than traveling — enjoying room service, pools, and the luxury of going nowhere. In K-pop, idol groups and solo artists often reference 호캉스 in their content and SNS posts during breaks between promotions.", example: "TWICE's vlogs of their Japan downtime between concerts — room service, face masks, matching pajamas — is peak 호캉스 content.", votesUp: 2890, votesDown: 34 }] },
    { term: "sohwakhaeng", slug: "sohwakhaeng", defs: [{ body: "소확행 — small certain happiness. From 소소하지만 확실한 행복 (small but certain happiness). The joy found in reliable, everyday pleasures — a good cup of coffee, finishing an album on your first listen, a bias posting at exactly the right moment. The term became culturally resonant during periods of uncertainty as a reminder that happiness doesn't have to be grand.", example: "New Jungkook selfie at 11pm on a Wednesday — absolute 소확행. Nothing else needed from this week.", votesUp: 5123, votesDown: 45 }] },
    { term: "kkultip", slug: "kkultip", defs: [{ body: "꿀팁 — golden tip, extremely useful advice. From 꿀 (honey) + tip. The best, most practical advice that makes a significant difference. Fan communities are full of 꿀팁 — streaming optimization methods, photocard storage hacks, lightstick battery tricks, concert survival guides. A well-formatted 꿀팁 post in a K-pop community is one of the most-saved types of content.", example: "Someone posted a 꿀팁 for getting better fansign lottery odds based on album-version distribution patterns — it got 40K upvotes.", votesUp: 4320, votesDown: 34 }] },
    { term: "gatsaeng", slug: "gatsaeng", defs: [{ body: "갓생 — the ideal productive life. From 갓 (god, as in 'godlike') + 생 (life). Living a disciplined, growth-focused, maximally productive existence. In K-pop fan communities, 갓생 discourse is common — fans admiring idols' early morning workout routines, multiple-language study sessions, and perfectionist rehearsal habits as examples of 갓생 living.", example: "Jimin's 갓생 is documented: 5am dance practice, vocal training, language study, charity work. The rest of us are just watching from our beds.", votesUp: 3890, votesDown: 56 }] },
    { term: "jinjja", slug: "jinjja", defs: [{ body: "진짜 — really, seriously, genuinely. One of the most-used words in casual Korean speech — the go-to intensifier for authenticity. In K-pop fan spaces, 진짜 is used to emphasize strong reactions: 진짜 daebak, 진짜 crazy, 진짜 I can't. Often appears in all caps for maximum emphasis.", example: "진짜 I watched that fancam twelve times. TWELVE. Their synchronization is not humanly possible.", votesUp: 4567, votesDown: 45 }] },
    // ── Relationship Slang ────────────────────────────────────────────────────
    { term: "sseom", slug: "sseom", defs: [{ body: "썸 — the undefined in-between stage before officially dating. From the English 'something' — as in 'there's something between us.' In Korean dating culture, 썸 is a recognized phase with its own vocabulary and rules. Fans apply it to idol OTPs (one true pairings) when there are subtle signs of romantic chemistry.", example: "The way they kept looking at each other during the collab stages — pure 썸 energy. That friendship is either already a relationship or about to be.", votesUp: 4567, votesDown: 89 }] },
    { term: "mildang", slug: "mildang", defs: [{ body: "밀당 — push-pull dynamic in romance. From 밀다 (to push) + 당기다 (to pull). The romantic tension of alternately showing interest and pulling back to maintain mystery and attraction. In K-pop, used to describe the energy between members in shipping contexts or to describe an idol's relationship management style in dramas.", example: "The entire plot of that drama is textbook 밀당 — he's interested, she pulls away; she opens up, he becomes distant. Twenty episodes of this.", votesUp: 3234, votesDown: 45 }] },
    { term: "geumsappa", slug: "geumsappa", defs: [{ body: "금사빠 — someone who falls in love quickly. Short for 금방 사랑에 빠지는 사람 (a person who falls in love quickly). In fan culture, used to affectionately describe fans who immediately obsess over a new group after one video, or fans who have a different bias every week as new content comes out.", example: "I'm a self-diagnosed 금사빠 — watched one aespa comeback stage and suddenly I have three photo book orders and a streaming plan.", votesUp: 4120, votesDown: 56 }] },
    { term: "namchin", slug: "namchin", defs: [{ body: "남친 — boyfriend. Shortened from 남자친구 (namja chingu). One of the most-used relationship terms in Korean casual speech. In K-pop, dating scandals involving idol 남친 revelations are among the highest-impact events in fan communities. Some fans use it affectionately to refer to their bias ('he's my 남친 in another life').", example: "The comment section of every fancam of V: 남친력 대박. (남친력 = boyfriend material energy)", votesUp: 3456, votesDown: 78 }] },
    { term: "yeochin", slug: "yeochin", defs: [{ body: "여친 — girlfriend. Shortened from 여자친구 (yeoja chingu). The female counterpart to 남친. Also the name of a K-pop group (GFRIEND/여자친구), which has created layers of fan confusion over the years. In stan culture, female idol dating revelations involving 여친 relationships generate equally intense fan reactions.", example: "After the dating news broke, thousands of fans rewatched old vlogs trying to find evidence of the 여친 dynamic they'd somehow missed.", votesUp: 3120, votesDown: 67 }] },
    { term: "namsachin", slug: "namsachin", defs: [{ body: "남사친 — male friend (explicitly platonic). Shortened from 남자 사람 친구 (male person friend), as opposed to 남자친구 (boyfriend). The distinction matters in Korean social dynamics — having a 남사친 is culturally different from having a 남자친구. In K-pop shipping culture, fans debate whether member pairings are 남사친 level or something more.", example: "She insisted he's just her 남사친 from the trainee days — fans with access to their old social media disagreed.", votesUp: 2890, votesDown: 45 }] },
    { term: "yeosachin", slug: "yeosachin", defs: [{ body: "여사친 — female friend (explicitly platonic). The female version of 남사친. In K-pop, when male idols are photographed with women, the label often clarifies the relationship as 여사친 to manage fan reactions. The term acknowledges that male and female friendships exist without romantic implications.", example: "The airport photo went viral — but they confirmed she's just a 여사친 from before his trainee days, not a dating partner.", votesUp: 2456, votesDown: 56 }] },
    { term: "mossol", slug: "mossol", defs: [{ body: "모쏠 — someone who has never been in a romantic relationship. From 모태솔로 (mottae solo, literally 'solo since before birth from the womb'). Used self-deprecatingly or affectionately. In K-pop fan culture, both fans and idols sometimes identify as 모쏠, and it's become a normalized, non-judgmental term.", example: "Jungkook called himself a 모쏠 during a candid stream and three different fandoms simultaneously declared it the most relatable thing he'd ever said.", votesUp: 3780, votesDown: 34 }] },
    { term: "jjaksarang", slug: "jjaksarang", defs: [{ body: "짝사랑 — one-sided love, unrequited feelings. One of the most relatable Korean concepts with no clean English equivalent. The experience of loving someone who doesn't know or doesn't reciprocate. In K-pop, the term applies to fan relationships with their bias (loving from afar) and is referenced in countless Korean song lyrics.", example: "Half of K-pop's best ballads are about 짝사랑 — the longing, the hope, and the quiet acceptance. It's the genre's emotional foundation.", votesUp: 5678, votesDown: 45 }] },
    { term: "aigoo", slug: "aigoo", defs: [{ body: "아이고 — an expression of exasperation, mild frustration, surprise, or exhaustion. The Korean equivalent of 'oh my,' 'good grief,' or 'ugh.' Used constantly in K-drama dialogue and real conversation. International K-pop fans have adopted it as an all-purpose emotional release word.", example: "She saw the photocard rip while unboxing — 아이고, four copies and this is the one I needed.", votesUp: 4890, votesDown: 56 }] },
    { term: "dolsing", slug: "dolsing", defs: [{ body: "돌싱 — divorced and re-entering the dating scene. Short for 돌아온 싱글 (returned single). In K-pop fan culture, playfully extended to any situation where someone leaves a fandom and then comes back — 'fandom divorce followed by dramatic return.' Also used when fans discover a previously dismissed group and join late.", example: "I thought I had 탈덕 from kpop for good but here I am 3 months later — full 돌싱, new group, new photocards.", votesUp: 2345, votesDown: 34 }] },
    { term: "aein", slug: "aein", defs: [{ body: "애인 — romantic partner, lover. A general term for a person one is in a romantic relationship with, regardless of gender. Used in K-pop both in lyrics (many songs address an 애인) and in dating scandal coverage. Fans sometimes use 애인 to describe their imaginary relationship with their bias.", example: "The album's entire concept is a love story told from the perspective of someone who just found out their 애인 was never real.", votesUp: 2890, votesDown: 34 }] },
    // ── Lifestyle / Food / Social ─────────────────────────────────────────────
    { term: "honbap", slug: "honbap", defs: [{ body: "혼밥 — eating alone. From 혼자 (alone) + 밥 (meal). Eating solo, without company. Once stigmatized in Korea's highly communal food culture, 혼밥 was normalized in the mid-2010s and is now fully accepted. K-pop idols who eat alone on camera in vlog content often make it look aspirational — peaceful, self-sufficient, aesthetically composed.", example: "Yoongi's 혼밥 vlog aesthetic — ramyeon, dim lighting, books nearby — is responsible for thousands of fans learning to enjoy eating alone.", votesUp: 4321, votesDown: 45 }] },
    { term: "honsul", slug: "honsul", defs: [{ body: "혼술 — drinking alone. From 혼자 (alone) + 술 (alcohol). The practice of drinking solo at home or at a bar. Like 혼밥, 혼술 has been romanticized in Korean media — quiet evenings with beer and snacks watching a comfort show. Many K-pop idol vlogs feature casual 혼술 moments that fans find unexpectedly intimate.", example: "Suga's occasional 혼술 content — a beer, a playlist, minimal commentary — generates some of his most-viewed Weverse posts. The vibe is unmatched.", votesUp: 3456, votesDown: 56 }] },
    { term: "chimaek", slug: "chimaek", defs: [{ body: "치맥 — fried chicken and beer. From 치킨 (chicken) + 맥주 (beer). Korea's beloved classic food pairing, elevated to national institution status. 치맥 culture includes specific restaurants, delivery apps, and even a dedicated festival in Daegu. K-pop groups regularly reference 치맥 in reality shows and appear in chicken brand endorsements.", example: "The TWICE 치맥 commercial is probably the most-viewed chicken ad in Korean history. They ate so convincingly fans started a fan theory that chicken is their actual source of power.", votesUp: 5432, votesDown: 67 }] },
    { term: "somaek", slug: "somaek", defs: [{ body: "소맥 — soju and beer mix. From 소주 (soju) + 맥주 (beer). A popular DIY cocktail: beer mixed with soju in a glass, often with a specific stir or bomb technique. 소맥 culture includes ritual mixing methods and ratios. K-pop groups are frequently shown making 소맥 in variety show drinking games and fan-favorite behind-the-scenes content.", example: "The members argued about the perfect 소맥 ratio for an entire 10-minute segment. This is the content that keeps variety show channels alive.", votesUp: 3890, votesDown: 45 }] },
    { term: "ajeom", slug: "ajeom", defs: [{ body: "아점 — brunch. From 아침 (breakfast) + 점심 (lunch). A portmanteau for the late morning/early afternoon meal. Common in K-pop idol vlogs and content since idol schedules often push their first meal deep into the day. 아점 culture in Korea includes specific menus and cafe aesthetics that fans recreate.", example: "Jungkook's ajeom aesthetic — takeout from a convenience store at noon after morning practice — is peak relatable idol life.", votesUp: 2678, votesDown: 23 }] },
    { term: "alba", slug: "alba", defs: [{ body: "알바 — part-time job. Shortened from 아르바이트, borrowed from the German word Arbeit. In Korea, most K-pop idols worked or considered working 알바 jobs before being scouted. Pre-debut 알바 stories are a staple of idol biopics and fan lore. Fans who discuss the industry often reference how many trainees work 알바 to fund their own training costs.", example: "Before SM discovered her, she was working 알바 at a coffee shop — the scouting story became one of the most-shared pre-debut facts about her.", votesUp: 2890, votesDown: 34 }] },
    { term: "naedonnaesan", slug: "naedonnaesan", defs: [{ body: "내돈내산 — 'bought with my own money.' From 내 돈 내가 산 (I bought it with my own money). Used on social media to signal that a review or recommendation is unsponsored and genuine. As K-pop influencers increasingly have brand deals, fans use 내돈내산 reviews to find trustworthy product opinions — especially for albums, lightsticks, and merchandise.", example: "Her 내돈내산 album unboxing showed all four versions without hiding the photocards she pulled — actual honest content.", votesUp: 3210, votesDown: 34 }] },
    { term: "ounwan", slug: "ounwan", defs: [{ body: "오운완 — workout complete. Short for 오늘 운동 완료 (today's workout completed). Used as a hashtag or caption when posting post-gym selfies or workout documentation. Idol workout content tagged 오운완 generates massive engagement — K-pop fans are deeply invested in idol fitness routines and gym selfies.", example: "Jungkook posted an 오운완 gym selfie at 2am and it got 4M likes in under an hour. His arms were a topic of academic-level analysis for days.", votesUp: 4567, votesDown: 67 }] },
    { term: "hyeonsaeng", slug: "hyeonsaeng", defs: [{ body: "현생 — real life, offline existence. From 현실 생활 (actual/present life). Used when acknowledging one must return from the K-pop internet world to real life — homework, work, responsibilities. 현생 is often invoked apologetically in fan communities: 'brb, 현생 calls.' Also used to describe how K-pop fandom occasionally needs to be balanced with offline existence.", example: "That comeback dropped on a Monday before finals week — my 현생 is in chaos but I've already streamed it 30 times.", votesUp: 3456, votesDown: 45 }] },
    { term: "jeongjuhaeng", slug: "jeongjuhaeng", defs: [{ body: "정주행 — binge-watching or listening from the very beginning. From 정방향 (forward/proper direction) + 주행 (driving/running). Going back to episode one, track one, or debut content and working forward chronologically. In K-pop, fans recommend 정주행 as the official way to truly understand a group's arc and growth.", example: "Someone asked how to get into BTS — the only correct answer is full 정주행: NO MORE DREAM to present. Clear your weekend.", votesUp: 5234, votesDown: 56 }] },
    { term: "wangtta", slug: "wangtta", defs: [{ body: "왕따 — social outcast, someone who is bullied or excluded from a group. From 왕 (king) + 따돌림 (exclusion) — the 'king of being excluded.' A serious term covering both schoolyard bullying and adult social exclusion. In K-pop, wangtta allegations against groups or labels — claims that certain members are isolated from their peers — are among the most damaging controversies.", example: "The whistleblower's post alleged that the company had been systematically creating 왕따 conditions for the member as pressure to exit the group.", votesUp: 4123, votesDown: 123 }] },
    { term: "omo", slug: "omo", defs: [{ body: "오모 / 어머 — 'oh my!' An expression of surprise, delight, or mild shock. More common among women. International K-pop fans absorbed it from K-dramas where female characters exclaim it constantly. It has become a universal K-pop-adjacent reaction word in international fan communities, often used as 'OMO!'", example: "OMO OMO OMO — he actually walked off the stage and into the fan section. Every camera in the arena turned at once.", votesUp: 5678, votesDown: 67 }] },
    { term: "pumjeollam", slug: "pumjeollam", defs: [{ body: "품절남 — 'sold out man' / a man who is taken and off the market. From 품절 (sold out) + 남 (man). Used when a beloved male celebrity confirms a relationship — he's officially 'sold out.' The female version is 품절녀. The term reflects K-pop's merchandise-market vocabulary bleeding into relationship discourse.", example: "When the dating news confirmed he had a girlfriend, his fan community spent two days mourning their newly 품절남 bias.", votesUp: 3120, votesDown: 78 }] },
    { term: "tsundere", slug: "tsundere", defs: [{ body: "츤데레 — cold on the outside, warm on the inside. From Japanese 'tsundere' (ツンデレ), borrowed widely into Korean youth culture. Describes someone who initially acts aloof, dismissive, or even rude but reveals genuine warmth and care over time. Many K-pop idols are fan-labeled tsundere — idols who pretend not to care but are obviously devoted to their members or fans.", example: "Yoongi acts 츤데레 in every interview — 'I don't care about award shows' — and then cries every single time BTS wins one.", votesUp: 5890, votesDown: 67 }] },
    { term: "title track", slug: "title-track", defs: [{ body: "타이틀곡 — the main single of an album release. The song that receives the primary promotional push: the most elaborate music video, the performance on music shows, the fanmeet showcase. Title track choice is a major label decision and often determines whether a comeback is considered successful. Fans sometimes campaign for different b-sides to receive title track treatment.", example: "The label picked 'Pink Venom' as the title track, but fans argued 'Shut Down' deserved it — the debate shaped BLACKPINK's entire 'BORN PINK' era discourse.", votesUp: 3890, votesDown: 45 }] },
    { term: "aegyo-sal", slug: "aegyo-sal", defs: [{ body: "애교살 — the small pad of fat directly under the eye that creates a youthful, cute appearance. Literally 'aegyo fat.' Considered highly desirable in Korean beauty standards — associated with youth, warmth, and approachability. K-pop idols with pronounced 애교살 are often described as having an irresistibly cute visual. Some fans get cosmetic procedures to enhance theirs.", example: "Tzuyu's 애교살 is considered a defining part of her visual — the subtle fullness under her eyes is a constant subject of appreciation in ONCE beauty discussions.", votesUp: 3456, votesDown: 45 }] },
    { term: "mwongmi", slug: "mwongmi", defs: [{ body: "뭥미 — 'what the heck is this?' / 'what even is this?' An internet-born expression of confused bewilderment. Originally a typo of 뭐임 (what is this?) that became a meme. In K-pop fan communities, used to react to inexplicable decisions — a bizarre concept choice, a confusing music video plot, or an unexpected collab that makes no logical sense but somehow works.", example: "뭥미?? BLACKPINK × LE SSERAFIM × NewJeans on one stage for a 10-minute medley?? My brain left the building. I'm just hands.", votesUp: 3789, votesDown: 45 }] },
  ];

  for (const t of slangTerms) {
    try {
      const existing = await prisma.codedTerm.findUnique({ where: { slug: t.slug } });
      if (existing) continue;
      const term = await prisma.codedTerm.create({ data: { slug: t.slug, term: t.term } });
    ...
    } catch { /* skip on slug conflict */ }
  }

  console.log("✅ Seed complete");
  console.log(`   Labels: 12 | Groups: 30+ | Artists seeded with lyrics | 21 Cities in DB | 100 new slang terms added`);
}
