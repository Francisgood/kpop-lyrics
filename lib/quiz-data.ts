...
export const QUIZZES: QuizCategory[] = [
  ...
  },
  {
    id: "bts",
    slug: "bts",
    title: "BTS Quiz: Members, Songs & Records",
    titleEs: "Trivia de BTS: Miembros, Canciones y Récords",
    blurb: "Seven members, one leader, a decade of records — how well do you actually know Bangtan?",
    blurbEs: "Siete miembros, un líder, una década de récords — ¿de verdad conoces a Bangtan?",
    description: "Who leads BTS? Which member records as Agust D? How many weeks did Butter sit at #1? Test yourself on BTS members, songs and chart records in this 8-question quiz on Aegyo Arena.",
    descriptionEs: "¿Quién lidera BTS? ¿Qué miembro graba como Agust D? ¿Cuántas semanas estuvo Butter en el #1? Ponte a prueba con los miembros, canciones y récords de BTS en esta trivia de 8 preguntas en Aegyo Arena.",
    label: "BTS",
    emoji: "💜",
    accent: "#7B61FF",
    questions: [
      {
        q: "BTS debuted on June 13, 2013. What was the title track of their debut single album, 2 Cool 4 Skool?",
        qEs: "BTS debutó el 13 de junio de 2013. ¿Cuál fue el tema principal de su álbum sencillo debut, 2 Cool 4 Skool?",
        // options are song titles — no Es variant needed, they fall back to English.
        options: ["No More Dream", "Boy In Luv", "N.O", "Danger"],
        answer: 0,
        explanation: "'No More Dream' opened 2 Cool 4 Skool — a hip-hop track aimed at the pressure Korean teenagers face to chase grades and a safe job instead of their own ambitions. The school trilogy it launched set BTS's early identity as a group writing about its own generation.",
        explanationEs: "'No More Dream' abrió 2 Cool 4 Skool — un tema de hip-hop dirigido a la presión que viven los adolescentes coreanos para perseguir notas y un trabajo seguro en vez de sus propias ambiciones. La trilogía escolar que inauguró definió la identidad temprana de BTS como un grupo que escribía sobre su propia generación.",
      },
      {
        q: "Who is the oldest member of BTS?",
        qEs: "¿Quién es el miembro mayor de BTS?",
        options: ["Jin", "RM", "Suga", "j-hope"],
        answer: 0,
        explanation: "Jin (Kim Seokjin), born December 4, 1992, is the eldest. Jungkook, born September 1, 1997, is the maknae — the youngest. Age order matters in Korean group culture: it shapes the honorifics members use with each other.",
        explanationEs: "Jin (Kim Seokjin), nacido el 4 de diciembre de 1992, es el mayor. Jungkook, nacido el 1 de septiembre de 1997, es el maknae — el menor. El orden de edad importa en la cultura de grupos coreana: define los honoríficos que usan entre ellos.",
      },
      {
        q: "Who is the leader of BTS?",
        qEs: "¿Quién es el líder de BTS?",
        options: ["Jimin", "RM", "V", "Jungkook"],
        answer: 1,
        explanation: "RM (Kim Namjoon) was the first member recruited to the group and has led it since debut. He also delivered the 'Speak Yourself' address to the UN General Assembly in 2018.",
        explanationEs: "RM (Kim Namjoon) fue el primer miembro reclutado y lidera el grupo desde el debut. También dio el discurso 'Speak Yourself' ante la Asamblea General de la ONU en 2018.",
      },
      {
        q: "Suga releases his solo mixtapes and albums under which alter ego?",
        qEs: "¿Bajo qué alter ego publica Suga sus mixtapes y álbumes en solitario?",
        options: ["Agust D", "D-Boy", "Slow Rabbit", "Gloss"],
        answer: 0,
        explanation: "Agust D reverses 'DT Suga' — DT for Daegu Town, his home city — while also reading as August. He used the name for the 2016 mixtape Agust D, 2020's D-2 and the 2023 album D-DAY.",
        explanationEs: "Agust D invierte 'DT Suga' — DT por Daegu Town, su ciudad natal — y a la vez se lee como August. Usó el nombre para el mixtape Agust D de 2016, D-2 en 2020 y el álbum D-DAY en 2023.",
      },
      {
        q: "What made the 2020 single 'Dynamite' a first for BTS?",
        qEs: "¿Qué hizo del sencillo 'Dynamite' de 2020 un primero para BTS?",
        options: [
          "It was their first all-English single, and their first #1 on the Billboard Hot 100",
          "It was their first single to feature another artist",
          "It was their first fully self-produced single",
          "It was their first single released without a music video",
        ],
        optionsEs: [
          "Fue su primer sencillo totalmente en inglés y su primer #1 en el Billboard Hot 100",
          "Fue su primer sencillo con otro artista invitado",
          "Fue su primer sencillo producido enteramente por ellos",
          "Fue su primer sencillo lanzado sin video musical",
        ],
        answer: 0,
        explanation: "'Dynamite' was BTS's first fully English-language single, and it entered the Billboard Hot 100 at #1 in September 2020 — the first time any Korean act had debuted at the top of that chart.",
        explanationEs: "'Dynamite' fue el primer sencillo totalmente en inglés de BTS, y entró al Billboard Hot 100 en el #1 en septiembre de 2020 — la primera vez que un acto coreano debutaba en la cima de esa lista.",
      },
      {
        q: "How many weeks did 'Butter' spend at #1 on the Billboard Hot 100 in 2021?",
        qEs: "¿Cuántas semanas pasó 'Butter' en el #1 del Billboard Hot 100 en 2021?",
        options: ["Two", "Five", "Ten", "Fifteen"],
        optionsEs: ["Dos", "Cinco", "Diez", "Quince"],
        answer: 2,
        explanation: "Ten non-consecutive weeks — more than any other song that year. 'Butter' was written as a summer single and ended up defining BTS's peak crossover run on US radio.",
        explanationEs: "Diez semanas no consecutivas — más que cualquier otra canción de ese año. 'Butter' se escribió como sencillo de verano y terminó definiendo el punto máximo del cruce de BTS en la radio estadounidense.",
      },
      {
        q: "BTS's fandom name, ARMY, is an acronym. What does it stand for?",
        qEs: "El nombre del fandom de BTS, ARMY, es un acrónimo. ¿Qué significa?",
        options: [
          "Adorable Representative M.C. for Youth",
          "Always Ready Music Youth",
          "A Real Music Yearning",
          "Adorable Rap Music for Youth",
        ],
        answer: 0,
        explanation: "ARMY stands for 'Adorable Representative M.C. for Youth'. The military framing pairs with the group's Korean name — 방탄소년단 (Bangtan Sonyeondan), 'Bulletproof Boy Scouts': armour, and the people it exists to protect.",
        explanationEs: "ARMY significa 'Adorable Representative M.C. for Youth'. El marco militar hace juego con el nombre coreano del grupo — 방탄소년단 (Bangtan Sonyeondan), 'Escuadrón Juvenil a Prueba de Balas': la armadura, y la gente a la que protege.",
      },
      {
        q: "In 2023, Jimin's 'Like Crazy' set which record?",
        qEs: "En 2023, 'Like Crazy' de Jimin estableció ¿qué récord?",
        options: [
          "First song by a Korean soloist to debut at #1 on the Billboard Hot 100",
          "First K-pop song to win a Grammy",
          "First Korean-language song to top the UK singles chart",
          "First K-pop solo single to sell a million physical copies in the US",
        ],
        optionsEs: [
          "Primera canción de un solista coreano en debutar en el #1 del Billboard Hot 100",
          "Primera canción de K-pop en ganar un Grammy",
          "Primera canción en coreano en encabezar la lista de sencillos del Reino Unido",
          "Primer sencillo solista de K-pop en vender un millón de copias físicas en EE. UU.",
        ],
        answer: 0,
        explanation: "'Like Crazy', from the album FACE, entered the Hot 100 at #1 in April 2023 — the first Korean solo artist to manage it. BTS had already done it as a group several times over, starting with 'Dynamite'.",
        explanationEs: "'Like Crazy', del álbum FACE, entró al Hot 100 en el #1 en abril de 2023 — el primer artista solista coreano en lograrlo. BTS ya lo había hecho como grupo varias veces, empezando por 'Dynamite'.",
      },
    ],
  },
  {
    id: "le-sserafim",
    slug: "le-sserafim",
    title: "LE SSERAFIM Quiz: Members, Lyrics & Records",
    titleEs: "Trivia de LE SSERAFIM: Miembros, Letras y Récords",
    blurb: "Toe shoes, an anagram, and a chorus that asks what you're looking at.",
    blurbEs: "Zapatillas de punta, un anagrama y un coro que pregunta qué estás mirando.",
    description: "What is LE SSERAFIM an anagram of? Whose ballet past does the ANTIFRAGILE 'toe shoes' line point to? Test yourself on LE SSERAFIM members, lyrics and records in this 8-question quiz on Aegyo Arena.",
    descriptionEs: "¿De qué frase es anagrama LE SSERAFIM? ¿Al pasado de qué miembro apunta el verso de las 'toe shoes' en ANTIFRAGILE? Ponte a prueba con los miembros, letras y récords de LE SSERAFIM en esta trivia de 8 preguntas en Aegyo Arena.",
    label: "LE SSERAFIM",
    emoji: "🖤",
    accent: "#3B6BF0",
    questions: [
      {
        q: "The name LE SSERAFIM is an anagram of which phrase?",
        qEs: "El nombre LE SSERAFIM es un anagrama de ¿qué frase?",
        options: ["IM FEARLESS", "FIRE SEALS", "REAL SELVES", "MISS FLARE"],
        answer: 0,
        explanation: "LE SSERAFIM rearranges the letters of 'IM FEARLESS' — the group's whole thesis stated inside its own name. The debut title track was 'FEARLESS' and the fandom is FEARNOT.",
        explanationEs: "LE SSERAFIM reordena las letras de 'IM FEARLESS' — toda la tesis del grupo declarada dentro de su propio nombre. El tema debut fue 'FEARLESS' y el fandom se llama FEARNOT.",
      },
      {
        q: "Who is the oldest member of LE SSERAFIM?",
        qEs: "¿Quién es la miembro mayor de LE SSERAFIM?",
        options: ["Sakura", "Kim Chaewon", "Huh Yunjin", "Hong Eunchae"],
        answer: 0,
        explanation: "Miyawaki Sakura, born in 1998, is the eldest — and had already had two careers before this one, in Japan's HKT48 and then in IZ*ONE. Hong Eunchae, born in 2006, is the maknae.",
        explanationEs: "Miyawaki Sakura, nacida en 1998, es la mayor — y ya había tenido dos carreras antes de esta, en HKT48 de Japón y luego en IZ*ONE. Hong Eunchae, nacida en 2006, es la maknae.",
      },
      {
        q: "In ANTIFRAGILE, the pre-chorus line '잊지 마 내가 두고 온 toe shoes' — 'don't forget the toe shoes I left behind' — points to which member's past?",
        qEs: "En ANTIFRAGILE, el verso del pre-coro '잊지 마 내가 두고 온 toe shoes' — 'no olvides las zapatillas de punta que dejé atrás' — apunta al pasado de ¿qué miembro?",
        options: [
          "Kazuha, who trained as a classical ballet dancer",
          "Sakura, who was already an idol in Japan",
          "Huh Yunjin, who trained in musical theatre",
          "Kim Chaewon, who was a competitive figure skater",
        ],
        optionsEs: [
          "Kazuha, que se formó como bailarina de ballet clásico",
          "Sakura, que ya era idol en Japón",
          "Huh Yunjin, que se formó en teatro musical",
          "Kim Chaewon, que fue patinadora artística de competición",
        ],
        answer: 0,
        explanation: "Kazuha trained in classical ballet, including at the Dutch National Ballet Academy, before auditioning. 'Toe shoes' are pointe shoes — the line reframes leaving ballet as something she chose, not something she lost.",
        explanationEs: "Kazuha se formó en ballet clásico, incluso en la Academia del Ballet Nacional Holandés, antes de audicionar. Las 'toe shoes' son zapatillas de punta — el verso replantea dejar el ballet como algo que ella eligió, no algo que perdió.",
      },
      {
        q: "ANTIFRAGILE's refrain runs '부서져도 더 강해져'. What does it mean?",
        qEs: "El estribillo de ANTIFRAGILE dice '부서져도 더 강해져'. ¿Qué significa?",
        options: [
          "'Even broken, I grow stronger'",
          "'Don't break what you can't fix'",
          "'I break everything I touch'",
          "'What's broken stays broken'",
        ],
        optionsEs: [
          "'Aunque me rompa, me hago más fuerte'",
          "'No rompas lo que no puedes arreglar'",
          "'Rompo todo lo que toco'",
          "'Lo que se rompe, roto se queda'",
        ],
        answer: 0,
        explanation: "The hook states the idea the title borrows from Nassim Taleb: antifragile things don't merely survive stress, they improve because of it. An English line in the same song spells it out — 'stress, pain, I turn it into gain'.",
        explanationEs: "El gancho enuncia la idea que el título toma de Nassim Taleb: lo antifrágil no solo sobrevive al estrés, mejora gracias a él. Un verso en inglés de la misma canción lo dice sin rodeos — 'stress, pain, I turn it into gain'.",
      },
      {
        q: "Which LE SSERAFIM song closes its post-chorus with 'But nothing counts after midnight'?",
        qEs: "¿Qué canción de LE SSERAFIM cierra su post-coro con 'But nothing counts after midnight'?",
        options: ["Perfect Night", "EASY", "ANTIFRAGILE", "UNFORGIVEN"],
        answer: 0,
        explanation: "'Perfect Night', an all-English single released in 2023 alongside a collaboration with Overwatch 2. The full couplet is 'I'd care at 11:59 / But nothing counts after midnight'.",
        explanationEs: "'Perfect Night', un sencillo totalmente en inglés lanzado en 2023 junto a una colaboración con Overwatch 2. El pareado completo es 'I'd care at 11:59 / But nothing counts after midnight'.",
      },
      {
        q: "Which line is repeated through the chorus of the debut title track FEARLESS?",
        qEs: "¿Qué verso se repite a lo largo del coro del tema debut FEARLESS?",
        options: [
          "'What you lookin' at?'",
        ...
        answer: 0,
        explanation: "The chorus taunts with 'What you lookin' at?' before turning it into a warning — 'You should get away'. Sakura and Kim Chaewon carry the hook.",
        explanationEs: "El coro provoca con 'What you lookin' at?' antes de convertirlo en advertencia — 'You should get away'. Sakura y Kim Chaewon llevan el gancho.",
      },
      {
        q: "The 2023 single UNFORGIVEN features guitar from which musician?",
        qEs: "El sencillo UNFORGIVEN de 2023 incluye la guitarra de ¿qué músico?",
        options: ["Nile Rodgers", "John Mayer", "Tom Morello", "Carlos Santana"],
        answer: 0,
        explanation: "Nile Rodgers — the Chic guitarist behind 'Le Freak', 'Good Times' and Daft Punk's 'Get Lucky' — played on UNFORGIVEN, whose Western-outlaw framing turns being unforgiven into a badge rather than a verdict.",
        explanationEs: "Nile Rodgers — el guitarrista de Chic detrás de 'Le Freak', 'Good Times' y 'Get Lucky' de Daft Punk — tocó en UNFORGIVEN, cuyo marco de forajido del Oeste convierte el no ser perdonada en una insignia y no en una condena.",
      },
      {
        q: "LE SSERAFIM debuted in May 2022 with how many members?",
        qEs: "¿Con cuántas integrantes debutó LE SSERAFIM en mayo de 2022?",
        options: ["Five", "Six", "Four", "Seven"],
        optionsEs: ["Cinco", "Seis", "Cuatro", "Siete"],
        answer: 1,
        explanation: "They debuted as six. Kim Garam left in July 2022, and the group has promoted as five — Sakura, Kim Chaewon, Huh Yunjin, Kazuha and Hong Eunchae — ever since. Garam's lines are still on the original FEARLESS recording.",
        explanationEs: "Debutaron como seis. Kim Garam se fue en julio de 2022, y el grupo promociona como cinco — Sakura, Kim Chaewon, Huh Yunjin, Kazuha y Hong Eunchae — desde entonces. Las líneas de Garam siguen en la grabación original de FEARLESS.",
      },
    ],
  },
  {
    id: "aespa",
    slug: "aespa",
    title: "aespa Quiz: Members, Songs & Records",
    titleEs: "Trivia de aespa: Miembros, Canciones y Récords",
    blurb: "Four members, four ae-avatars, and a world called KWANGYA. Prove you can navigate it.",
    blurbEs: "Cuatro miembros, cuatro ae-avatares y un mundo llamado KWANGYA. Demuestra que sabes moverte en él.",
    description: "What does the name aespa actually mean? Which soundtrack did 'Next Level' come from? Test yourself on aespa members, songs and records in this 8-question quiz on Aegyo Arena.",
    descriptionEs: "¿Qué significa realmente el nombre aespa? ¿De qué banda sonora salió 'Next Level'? Ponte a prueba con los miembros, canciones y récords de aespa en esta trivia de 8 preguntas en Aegyo Arena.",
    label: "aespa",
    emoji: "🔮",
    accent: "#B4FF3A",
    questions: [
      {
        q: "aespa debuted in November 2020 with which single?",
        qEs: "aespa debutó en noviembre de 2020 con ¿qué sencillo?",
        options: ["Black Mamba", "Next Level", "Savage", "Forever"],
        answer: 0,
        explanation: "'Black Mamba' introduced both the group and its antagonist — the entity that severs each member from her ae-avatar. The music video became the fastest K-pop debut video to reach 100 million views.",
        explanationEs: "'Black Mamba' presentó al grupo y a su antagonista — la entidad que separa a cada miembro de su ae-avatar. El video se convirtió en el video debut de K-pop más rápido en llegar a 100 millones de vistas.",
      },
      {
        q: "Where does the name 'aespa' come from?",
        qEs: "¿De dónde viene el nombre 'aespa'?",
        options: [
          "'æ' — avatar and experience — joined to 'aspect'",
          "A Latin word meaning 'to strive'",
          "The initials of the four members' names",
          "'Aesthetic' plus 'space'",
        ],
        optionsEs: [
          "'æ' — avatar y experience — unido a 'aspect'",
          "Una palabra latina que significa 'esforzarse'",
          "Las iniciales de los nombres de las cuatro integrantes",
          "'Aesthetic' más 'space'",
        ],
        answer: 0,
        explanation: "SM built the name from 'æ', standing for avatar and experience, joined to 'aspect' — the two sides of the concept: the human member and her ae-avatar, meeting across a world called KWANGYA.",
        explanationEs: "SM construyó el nombre desde 'æ', por avatar y experience, unido a 'aspect' — los dos lados del concepto: la miembro humana y su ae-avatar, encontrándose a través de un mundo llamado KWANGYA.",
      },
      {
        q: "Which two aespa members are not Korean?",
        qEs: "¿Cuáles dos integrantes de aespa no son coreanas?",
        options: ["Giselle and Ningning", "Karina and Winter", "Winter and Ningning", "Karina and Giselle"],
        optionsEs: ["Giselle y Ningning", "Karina y Winter", "Winter y Ningning", "Karina y Giselle"],
        answer: 0,
        explanation: "Giselle (Uchinaga Aeri) is Japanese and Ningning (Ning Yizhuo) is Chinese; Karina and Winter are Korean. Ningning, born in 2002, is also the maknae.",
        explanationEs: "Giselle (Uchinaga Aeri) es japonesa y Ningning (Ning Yizhuo) es china; Karina y Winter son coreanas. Ningning, nacida en 2002, es además la maknae.",
      },
      {
        q: "What is aespa's fandom called?",
        qEs: "¿Cómo se llama el fandom de aespa?",
        options: ["MY", "MYSTIC", "AEBBY", "KWANGYA"],
        answer: 0,
        explanation: "'MY' — in the group's lore, the name of the bond between a member and her ae. KWANGYA is the fictional world the concept plays out in, not the fandom name.",
        explanationEs: "'MY' — en la mitología del grupo, el nombre del vínculo entre una miembro y su ae. KWANGYA es el mundo ficticio donde ocurre el concepto, no el nombre del fandom.",
      },
      {
        q: "The 2021 hit 'Next Level' was a rework of a song from which film soundtrack?",
        qEs: "El éxito de 2021 'Next Level' fue una reelaboración de una canción de ¿qué banda sonora?",
        options: ["Fast & Furious Presents: Hobbs & Shaw", "Black Panther", "Ocean's 8", "John Wick 3"],
        answer: 0,
        explanation: "The original 'Next Level' was an A$AP Ferg track from the Hobbs & Shaw soundtrack. aespa kept the title and the skeleton and rebuilt the rest — the abrupt tempo switches were the thing everyone argued about, then couldn't stop replaying.",
        explanationEs: "El 'Next Level' original era un tema de A$AP Ferg de la banda sonora de Hobbs & Shaw. aespa conservó el título y el esqueleto y reconstruyó el resto — los cambios bruscos de tempo fueron lo que todos discutieron, y luego no pudieron dejar de repetir.",
      },
      {
        q: "Who is the leader of aespa?",
        qEs: "¿Quién es la líder de aespa?",
        options: ["Karina", "Winter", "Giselle", "Ningning"],
        answer: 0,
        explanation: "Karina (Yu Jimin), born in 2000, leads the group and is usually its centre in choreography.",
        explanationEs: "Karina (Yu Jimin), nacida en 2000, lidera el grupo y suele ser su centro en la coreografía.",
      },
      {
        q: "In May 2024 aespa released two singles two weeks apart, around their first full-length album. Which two?",
        qEs: "En mayo de 2024 aespa lanzó dos sencillos con dos semanas de diferencia, alrededor de su primer álbum de larga duración. ¿Cuáles dos?",
        options: [
          "'Supernova' and 'Armageddon'",
          "'Spicy' and 'Drama'",
          "'Savage' and 'Girls'",
          "'Whiplash' and 'Dirty Work'",
        ],
        answer: 0,
        explanation: "'Supernova' arrived first as a pre-release, then 'Armageddon' followed as the title track of the album Armageddon — aespa's first full-length. 'Supernova' went on to dominate the Korean charts through that summer.",
        explanationEs: "'Supernova' llegó primero como pre-lanzamiento, y luego 'Armageddon' como tema principal del álbum Armageddon — el primero de larga duración de aespa. 'Supernova' terminó dominando las listas coreanas todo ese verano.",
      },
      {
        q: "In April 2022, barely seventeen months after debuting, aespa performed at which US festival?",
        qEs: "En abril de 2022, apenas diecisiete meses después de debutar, aespa se presentó en ¿qué festival estadounidense?",
        options: ["Coachella", "Lollapalooza", "Bonnaroo", "Governors Ball"],
        answer: 0,
        explanation: "aespa played Coachella in 2022 — before they had released a full-length album at all. The set leaned on 'Next Level' and 'Savage', the two songs that had made them unavoidable in their first eighteen months.",
        explanationEs: "aespa tocó en Coachella en 2022 — antes de haber lanzado siquiera un álbum de larga duración. El show se apoyó en 'Next Level' y 'Savage', las dos canciones que las habían vuelto ineludibles en sus primeros dieciocho meses.",
      },
    ],
  },
];
